...
<div>
    <div class="table_head">
        <h4>月度报表</h4>
        <div>
            <el-date-picker class="query-picker" v-model="queryMonth" type="month" placeholder="请选择月份" value-format="yyyyMM"></el-date-picker>
    ...
    <div class="pagination">
        <el-pagination background layout="prev, pager, next" :total="total" :page-size="pagesize" :current-page="currentPage" @current-change="handleCurrentChange"></el-pagination>
    </div>
</div>
</template>
