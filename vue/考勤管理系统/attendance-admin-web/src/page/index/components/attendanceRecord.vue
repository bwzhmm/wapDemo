<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="EXPLANATION" label="情况说明" width="160" align="center"></el-table-column>
      <el-table-column prop="APPLYSTATE" label="申请状态" width="100" align="center">
        <template slot-scope="scope">{{ applyState[scope.row.APPLYSTATE]}}</template>
      </el-table-column>
      <el-table-column prop="OVERTIME" label="加班时长（h）" width="110" align="center"></el-table-column>
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          >异常申请</el-button>
          <el-button class="opacity_65" type="text" size="small" v-else>已经确认</el-button>
        </template>
      </el-table-column>
    </el-table>
