<template>
    <div>
        ...
        <div class="exam_content_" v-else>
            <div class="exam_content_img"></div>
            <p class="exam_end">恭喜完成考试，图书馆读书证已被激活！</p>
                        ...
                        if(res.success){
                            if(res.items){
                                ...
                                res.items.forEach(element => {
                                    ...
                                    // console.log(element)
                                    // if(element.needstudytime){
                                    //     if(this.studytime>=element.needstudytime){
                                    //         element.showbtn = true
                                    //     }
                                    // }else{
                                    //     element.needstudytime = 0;
                                    //     if(this.studytime>=element.needstudytime){
                                    //         element.showbtn = true
                                    //     }
                                    // }
