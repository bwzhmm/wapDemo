    ...
    <div>
        <div class="examing_ clearfix">
            <div class="examing_left">
                <h3>答题卡<span>共{{examdetail.questionList.length}}题，满分{{examdetail.questionList[num].score}}分</span></h3>
            ...
            <div class="examing_right">
                <div class="examing_right_">
                    <h3>{{examdetail.questionList[num].quesType=='1'?'单选题':examdetail.questionList[num].quesType=='2'?'多选题':'判断题'}}<span class="singlenum">（{{examdetail.questionList[num].score}}分）</span> <span class="examing_time"><i></i> 剩余时间&nbsp;<em> {{formatexamtime.slice(3,4)}}{{formatexamtime.slice(4,5)}} : {{formatexamtime.slice(6,7)}}{{formatexamtime.slice(7,8)}}</em></span></h3>
        ...
        <div v-if="endexam_show" class="meng">
            <div class="meng_auto">
                ...
                <div class="btns">
                    <el-button @click="see_err" v-if="examdetail.two=='2'">错题回顾</el-button>
...
export default {
    ...
    methods: {
        //
        // in_opt(i){
        //     console.log('in',this.$refs.opts[i].getAttribute('class'));
        //     if(this.$refs.opts[i].getAttribute('class')!='opt_act act'){
        //         this.$refs.opts[i].setAttribute('class','opt_act')
        //     }else if(this.$refs.opts[i].getAttribute('class')=='act'){
        //         this.$refs.opts[i].setAttribute('class','opt_act act')
        //     }
        // },
        // out_opt(i){
        //     console.log('out',this.$refs.opts[i].getAttribute('class'));
        //     if(this.$refs.opts[i].getAttribute('class')=='opt_act'){
        //         this.$refs.opts[i].removeAttribute('class','opt_act')
        //     }else if(this.$refs.opts[i].getAttribute('class')=='act'){
        //         this.$refs.opts[i].removeAttribute('class','opt_act')
        //         this.$refs.opts[i].setAttribute('class','act')
        //     }
        // },
        //答题
        sel_ans(item,index){
