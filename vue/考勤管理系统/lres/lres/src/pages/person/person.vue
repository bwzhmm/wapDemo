...
<div>
    <div class="person_content_ clearfix">
        <div class="person_left">
            ...
            <div class="read_card">
                <h3>图书馆读书证</h3>
                <div v-if="personinfo.readerFlag=='1'">
                    <h3>{{personinfo.name}}</h3>
                    <p>图书馆读书证已激活</p>
                </div>
                <div v-else>
                    <p class="goexam_">图书馆读书证未激活</p>
                    <span class="goexam" @click="goexam">去考试</span>
                </div>
            </div>
        </div>
            ...
            <el-timeline>
                <el-timeline-item placement="bottom" v-for="(v,i) in bigThing" :key="i">
                    <el-card class="elcard_">
                        ...
                        <p v-if="v.type==3">{{v.isPass==0?'很遗憾，未通过模拟考试':'恭喜通过模拟考试'}},本次分数为<span class="nopasstext">{{v.score}}</span>分</p>
